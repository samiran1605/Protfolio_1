...
function ImageContainer({imageOrder}) {
  return (
    <>
    <div className="flex flex-row items-center gap-6 p-24">
          <img className={`rounded-full h-40 w-40 ${imageOrder}`} src='https://images.pexels.com/photos/1181271/pexels-photo-1181271.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' alt='dev image' />
